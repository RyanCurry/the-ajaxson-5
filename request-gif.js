...
function fetchAndDisplayGif(event) {
    ...
    if ( $("#captcha").val() !=5) {
        $("#captcha-error").attr("hidden",false);
        $("#captcha").addClass("error-field");
        return;
        }
$("#captcha").removeClass("error-field");
$("#captcha-error").attr("hidden",true);
    // get the user's input text from the DOM
    var searchQuery = $("input[name='tag']").val();//"dance"; // TODO should be e.g. "dance"
